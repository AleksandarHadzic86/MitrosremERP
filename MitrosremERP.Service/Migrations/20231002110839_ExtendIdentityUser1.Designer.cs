...
namespace MitrosremERP.Infrastructure.Migrations
{
    ...
    [Migration("20231002110839_ExtendApplicationUser1")]
    partial class ExtendApplicationUser1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MitrosremERP.Domain.Models.ZaposleniMitrosrem.Ugovor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("bb4f958e-eda8-4435-94bb-2a3c7edc42ea"),
                            BrojDanaGodisnjeg = 22,
                            BrojUgovora = "MS0001",
                            DatumPocetka = new DateOnly(1992, 2, 17),
                            TipUgovora = "Odredjeno",
                            ZaposleniId = new Guid("024f0f62-1964-430f-9dbd-f46fc5f9a119")
                        });
                });
            ...
            modelBuilder.Entity("MitrosremERP.Domain.Models.ZaposleniMitrosrem.Zaposleni", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("024f0f62-1964-430f-9dbd-f46fc5f9a119"),
                            Adresa = "Stari Sor",
                        ...
                        new
                        {
                            Id = new Guid("57c51060-9c5c-4443-975e-c46b6427b4d5"),
                            Adresa = "BB",
                            DatumRodjenja = new DateTime(2000, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "mitrosrem@ad.rs",
                            Grad = "Sid",
                        ...
                        new
                        {
                            Id = new Guid("4ad1be50-f025-4e82-b09e-89b453da738f"),
                            Adresa = "BB",
                            DatumRodjenja = new DateTime(2000, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "mitrosrem@ad.rs",
                            Grad = "Sabac",
                        ...
                        new
                        {
                            Id = new Guid("dad4ef07-78a2-4937-9313-9d4b488dd298"),
                            Adresa = "BB",
                            DatumRodjenja = new DateTime(2000, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "mitrosrem@ad.rs",
                            Grad = "Beograd",
                        ...
                        new
                        {
                            Id = new Guid("9fced6e4-289a-4c50-9559-311da6fb1878"),
                            Adresa = "Stari Sor",
                            DatumRodjenja = new DateTime(2000, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "mitrosrem@ad.rs",
                            Grad = "Sr.Mitrovica",
                        ...
                        new
                        {
                            Id = new Guid("bff8b745-30b5-430d-914e-185e40a1f576"),
                            Adresa = "BB",
                            DatumRodjenja = new DateTime(2000, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "mitrosrem@ad.rs",
                            Grad = "Sid",
                        ...
                        new
                        {
                            Id = new Guid("873d003f-f0a8-4cc1-9b8f-7aff6643bff0"),
                            Adresa = "BB",
                            DatumRodjenja = new DateTime(2000, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "mitrosrem@ad.rs",
                            Grad = "Sabac",
                        ...
                        new
                        {
                            Id = new Guid("7728393b-cba9-432c-88d4-182332918fd6"),
                            Adresa = "BB",
                            DatumRodjenja = new DateTime(2000, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "mitrosrem@ad.rs",
                            Grad = "Beograd",
